...
export const alertesRecentes: Alerte[] = [
  ...
  },
  {
    ...
    niveau: "info",
    canal: "email",
    message: "Température de Salle Test a atteint 28°C (seuil : 27°C)",
...
export const historiqueEvenements: EvenementHistorique[] = [
  {
    ...
    description: "Mouvement détecté dans Salle Test",
  ...
  },
  {
    ...
    description: "Température de Salle Test a atteint 28°C (seuil : 27°C)",
    timestamp: h(1).toISOString(),
  },
  {
    id: "hist-003",
  ...
  },
  {
    ...
    niveau: "info",
    titre: "Gaz élevé",
    description: "Taux de gaz de Salle Test a atteint 45% (seuil : 50%)",
    timestamp: h(2).toISOString(),
  },
  {
    id: "hist-006",
    ...
    description: "Taux d'humidité de Salle Test a atteint 82% (seuil : 80%)",
